...
app = FastAPI()
LOG_DIRS = ["logs", "logs_1", "logs_2"]  # Add all log directories here
...
def generate_ai_insights(logs: List[str]) -> str:
    ...
    try:
        ...
        if input_ids.size(1) == 0:
            return "AI Insight Generation Failed: Tokenized input is empty."
        ...
        if not response_text:
            return "AI Insight Generation Failed: No content generated."
